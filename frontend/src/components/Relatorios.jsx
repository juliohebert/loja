...
import { FileText, Download, Calendar, TrendingUp, Package, DollarSign, Filter, X, PieChart, Award, Users, ArrowUp, ArrowDown, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div className="relative scroll-indicator md:scroll-indicator-none">
              {/* Botão de navegação esquerda */}
              <button
                onClick={() => scrollTabs('left')}
                className="absolute left-0 top-0 bottom-0 z-10 bg-gradient-to-r from-white via-white to-transparent px-2 md:hidden flex items-center justify-center hover:bg-gray-50 transition-colors"
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Comparativo Mensal</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Comparativo Trimestral</span>
                </button>
                <button
                ...
                >
                  <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="text-sm sm:text-base">Vendas</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Estoque</span>
                </button>
                <button
                ...
                >
                  <PieChart className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="text-sm sm:text-base">Margens</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Curva ABC</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Vendedores</span>
                </button>
              </div>
              ...
              <button
                ...
                className="absolute right-0 top-0 bottom-0 z-10 bg-gradient-to-l from-white via-white to-transparent px-2 md:hidden flex items-center justify-center hover:bg-gray-50 transition-colors"
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center w-full sm:w-auto max-w-xs">
                    <input
                      ...
                      className="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-auto"
                    />
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center w-full sm:w-auto max-w-xs">
                    <select
                      ...
                      className="pl-3 pr-10 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-auto"
                    >
                    ...
                    {dadosVendas.map((venda) => (
                      <div key={venda.id} className="p-4 hover:bg-gray-50">
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-sm font-bold text-gray-900">#{venda.numeroVenda}</span>
                          <span className="text-xs text-gray-500">{venda.dataHora}</span>
                        </div>
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-600">Itens:</span>
                            <span className="font-medium text-gray-900">{venda.totalItens}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Subtotal:</span>
                            <span className="text-gray-900">{formatarPreco(venda.subtotal)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Desconto:</span>
                            <span className="text-gray-900">{formatarPreco(venda.desconto)}</span>
                          </div>
                          <div className="flex justify-between pt-2 border-t border-gray-200">
                            <span className="text-gray-600 font-medium">Total:</span>
                            <span className="font-bold text-gray-900">{formatarPreco(venda.total)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Pagamento:</span>
                            <span className="text-gray-900">{venda.formaPagamento}</span>
                          </div>
                          <div className="flex justify-between">
                      ...
                      <div key={index} className="p-4 hover:bg-gray-50">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="text-gray-900">{item.tamanho} / {item.cor}</span>
                          </div>
                          <div className="flex justify-between">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-gray-900">{item.limiteMinimo}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Valor Unit.:</span>
                            <span className="text-gray-900">{formatarPreco(item.valorUnitario)}</span>
                          </div>
                          <div className="flex justify-between pt-2 border-t border-gray-200">
                            <span className="text-gray-600 font-medium">Valor Total:</span>
                            <span className="font-bold text-gray-900">{formatarPreco(item.valorTotal)}</span>
                          </div>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="md:hidden divide-y divide-gray-200">
                      {[...dadosFinanceiro.receitas, ...dadosFinanceiro.despesas]
                        .sort((a, b) => b.data.localeCompare(a.data))
                        .map((lanc) => (
                        <div key={lanc.id} className="p-4 hover:bg-gray-50">
                          <div className="flex items-center justify-between mb-3">
                            <span className="text-xs text-gray-500">{lanc.data}</span>
                            <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                              lanc.tipo === 'receita' 
                                ? 'bg-green-100 text-green-700' 
                                : 'bg-red-100 text-red-700'
                          ...
                          <h4 className="text-sm font-bold text-gray-900 mb-2">{lanc.descricao}</h4>
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              <span className="text-gray-600">Categoria:</span>
                              <span className="text-gray-900">{lanc.categoria}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">Pagamento:</span>
                              <span className="text-gray-900">{lanc.formaPagamento}</span>
                            </div>
                            <div className="flex justify-between pt-2 border-t border-gray-200">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="md:hidden divide-y divide-gray-200">
                      {dadosCurvaABC.classeA?.map((produto, index) => (
                        <div key={index} className="p-4 hover:bg-gray-50">
                          <h4 className="text-sm font-bold text-gray-900 mb-3">{produto.nome}</h4>
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            <div>
                              <span className="text-gray-600 block mb-1">Quantidade</span>
                              <span className="font-medium text-gray-900">{produto.quantidade}</span>
                            </div>
                            <div>
                              <span className="text-gray-600 block mb-1">Faturamento</span>
                              <span className="font-bold text-gray-900">{formatarPreco(produto.faturamento)}</span>
                            </div>
                            <div>
                              <span className="text-gray-600 block mb-1">% Faturamento</span>
                              <span className="text-gray-900">{produto.percentualFaturamento.toFixed(2)}%</span>
                            </div>
                            <div>
                              <span className="text-gray-600 block mb-1">% Acumulado</span>
                              <span className="font-semibold text-green-700">{produto.percentualAcumulado.toFixed(2)}%</span>
                            </div>
                          </div>
                        </div>
                      ))}
                      ...
                      {dadosCurvaABC.classeB?.map((produto, index) => (
                        <div key={index} className="p-4 hover:bg-gray-50">
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                              <span className="text-gray-600 block mb-1">% Acumulado</span>
                              <span className="font-semibold text-yellow-700">{produto.percentualAcumulado.toFixed(2)}%</span>
                            </div>
                          </div>
                        </div>
                      ))}
                      ...
                      {dadosCurvaABC.classeC?.map((produto, index) => (
                        <div key={index} className="p-4 hover:bg-gray-50">
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                              <span className="text-gray-600 block mb-1">% Acumulado</span>
                              <span className="font-semibold text-red-700">{produto.percentualAcumulado.toFixed(2)}%</span>
                            </div>
                          </div>
                        </div>
                      ))}
                        ...
                        <div key={index} className="p-4 hover:bg-gray-50">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              {index === 1 && (
                                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-gray-700 font-bold text-lg">
                                  🥈
                                </span>
                              )}
                              {index === 2 && (
                              ...
                              {index > 2 && (
                                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-gray-600 font-semibold">
                                  {index + 1}º
                                </span>
                              )}
                              <h4 className="text-sm font-bold text-gray-900">{vendedor.vendedor}</h4>
                            </div>
                          </div>
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              <span className="text-gray-600">Total de Vendas:</span>
                              <span className="font-medium text-gray-900">{vendedor.totalVendas}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">Itens Vendidos:</span>
                              <span className="text-gray-900">{vendedor.totalItens}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">Ticket Médio:</span>
                              <span className="text-gray-900">{formatarPreco(vendedor.ticketMedio)}</span>
                            </div>
                            <div className="flex justify-between pt-2 border-t border-gray-200">
                              <span className="text-gray-600 font-medium">Faturamento:</span>
                              <span className="font-bold text-gray-900">{formatarPreco(vendedor.totalFaturamento)}</span>
                            </div>
                            <div className="pt-2">
                              <div className="flex items-center justify-between mb-1">
                                <span className="text-xs text-gray-600">% do Total</span>
                                <span className="text-sm font-semibold text-blue-600">{percentual.toFixed(1)}%</span>
                              </div>
